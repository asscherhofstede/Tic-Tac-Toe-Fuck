    ...
    public partial class Form1 : Form
    {
        ...
        //horizontaal 
           ...
           if ((D1.Text == D2.Text) && (D2.Text == D3.Text) && (D3.Text == D4.Text) && (!D1.Enabled))
           {
            ...
            if ((A2.Text == B2.Text) && (B2.Text == C2.Text) && (C2.Text == D2.Text))
            {
                There_Is_A_Winner = true;
            }
            if ((A3.Text == B3.Text) && (B3.Text == C3.Text) && (C3.Text == D3.Text))
            {
                There_Is_A_Winner = true;
            }
            if ((A4.Text == B4.Text) && (B4.Text == C4.Text) && (C4.Text == D4.Text))
            {
                There_Is_A_Winner = true;
            }
